...
<head>
	...
	#mhs tr:nth-child(even){background-color: #f2f2f2;}
...
<div id="container">
	<nav class="navbar navbar-dark" style="background-color: #9c225d;">
		<span class="navbar-brand mb-0 h1">Data Mahasiwa</span>
	</nav>
	<br>
	<div id="body">
		<table id="mhs">
	...
	<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development') ?  'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?> Adeliya RPL.</p>
</div>
